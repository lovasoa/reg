    ...
    <section class="validatable valid">
      {#if rules == true}
        <div class="ruleStyle">
          {#if language !== 'fr'}
            <p>
              * Each player in turn places a number between 1 and the total
              number of squares of the grid (the maximal number is 16 for a 4x4
              grid). Each number can only be placed once.
            </p>
            <p>
              * On a same row, column, or diagonal, the numbers must be either
